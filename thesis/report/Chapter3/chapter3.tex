...
\begin{figure}[H]
  \centering
  \includegraphics[width=.5\textwidth]{model1_results.pdf}
...
\begin{figure}[H]
  ...
  \begin{minipage}{\textwidth}
    ...
    \vspace{1cm}
      ...
      \centering
      \includegraphics[trim={2cm 15.3cm 20cm 0}, clip, width=.85\textwidth]{apex_definition.pdf}
    \end{minipage}\hfill
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{age_l3.pdf}
