...
The accuracy of the method is certainly hampered due to the variance in evolutionary constraints. Functionally more important sites are likely to be more constrained if they are important for survival and dominance of the organism.
