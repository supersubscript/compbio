...
\section*{Exercises}
  \begin{figure*}[p]
    ...
    \begin{subfigure}[b]{.49\textwidth}
      \includegraphics[width=\textwidth, trim = 2cm 6cm 2cm 6cm, clip]{{../figures/CADH1_HUMAN_e3_n2_m40_theta_0.3_pc_weight_0.5_histogram_}.pdf}
      \caption{ }
      \label{fig:human_fig1}
    \end{subfigure}~
    \begin{subfigure}[b]{.5\textwidth}
      \includegraphics[width=\textwidth, trim=2cm 7cm 2cm 7cm, clip]{{../figures/CADH1_HUMAN_e3_n2_m40_theta_0.3_pc_weight_0.5_Predicted_Constraints}.pdf}
      % \includegraphics[width=\textwidth, trim= 10cm 0 10cm 0, clip]{../figures/fig2}
      \caption{ }
      \label{fig:human_fig2}
    \end{subfigure}\\
    \begin{subfigure}[b]{.49\textwidth}
      \includegraphics[width=\textwidth, trim= 2cm 7cm 2cm 0cm, clip]{{../figures/CADH1_HUMAN_e3_n2_m40_theta_0.3_pc_weight_0.5_FPplot}.pdf}
      \caption{ }
      \label{fig:human_fig3}
    \end{subfigure}~
      \begin{subfigure}[b]{.5\textwidth}
      % \includegraphics[width=\textwidth, trim= 10cm 0cm 10cm 0, clip]{../figures/fig4 }
      \includegraphics[width=\textwidth, trim=2cm 7cm 2cm 7cm, clip]{{../figures/CADH1_HUMAN_e3_n2_m40_theta_0.3_pc_weight_0.5_Cmap_200}.pdf}
      \caption{ }
...
%     Cmap
%     FPplot
%     Predicted constraints / interactions
%   DIScores
%   DIscoresCompared
%   MI_DI
