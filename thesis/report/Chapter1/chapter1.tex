...
\nomenclature[z-CZ]{CZ}{Central zone. The region harbouring stem cells in the SAM.}                                                                        
...
\nomenclature[z-L3]{L3}{Cells below layers L1 and L2.}
...
\nomenclature[z-CLV3]{CLV3}{CLAVATA3}                                         
\nomenclature[z-WUS]{WUS}{WUSCHEL}                                             
\nomenclature[z-KAN]{KAN1}{KANADI1}                                           
...
Computer models in general have two separate main aims: exploration and validation.
...
\subsection{Molecular tuning determines the cellular phenotype} %Section - 1.2.1
...
Aside of the GRN regulating cellular identity, other classes of
