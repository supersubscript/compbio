...
\begin{multicols*}{2}
	...
	<<trajs, echo=FALSE, fig.height = 5, fig.env='figure', fig.cap="Things", cache = TRUE, fig.pos="H",fig.align='center'>>=
	...
	plot(1, type="n", axes=T, xlab="", ylab="", ylim=c(0,5), xlim = c(0,1003), bty = "n")
