...
\subsection{Role of the WUSCHEL-CLAVATA feedback loop} %Section - 1.2.1
...
unknown for their role in specifying pluripotency. \CITE % Rewrite this shit part



% Time-coordination through network motifs

\REWRITE
% What do CLV3 / WUS mutants do?
CLV3 / WUS mutants \\

% CLV3 stem cells orrrr\ldots? 
HORMONES \\
STM / Cytokinin / Auxin \\

How much of the details in GRN is known? \\

% Alongside CLV3 and WUS, the peripheral gene KANADI-1 (KAN1) plays and important role in
% regulating differentiation and organ initiation. While KAN1 is known to be bound and repressed
% by WUS, and hence preventing differentiation, there are both computational and experimental
% results pointing towards the opposite also being true – KAN1 repressing WUS. Together, this
% would form a double negative, i.e. positive, feedback loop [3], which is hypothesised to tempo-
% rally coordinate stem cell differentiation. However, these feedback loops can also be involved
% in amplifying noise, making it currently unclear what purpose these types of networks serve in
% the developmental programme of the SAM. A major focus of my project will involve verifying
% and exploring such gene regulatory mechanisms driving patterning and subsequent effects on
% developmental features such as cell size and growth rate.


\section{Lead into what I've done (TODO)}
