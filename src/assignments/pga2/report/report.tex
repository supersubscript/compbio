...
{\centering \includegraphics[width=\maxwidth]{figure/twocolumn-inference-1} 

}

\caption[Things]{Things}\label{fig:inference}
\end{figure}
\end{Schunk}
...
{\centering \includegraphics[width=\maxwidth]{figure/twocolumn-inference2-1} 

}

\caption[Things]{Things}\label{fig:inference2}
\end{figure}
\end{Schunk}
